...
create table dbo.funcionario (
    id int identity constraint funcionario_pk primary key,
...
create table dbo.salario (
    id int identity  constraint salario_pk primary key ,
